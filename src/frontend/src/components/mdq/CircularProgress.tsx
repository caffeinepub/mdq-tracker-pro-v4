  ...
  return (
    <div className="flex flex-col items-center justify-center py-2">
      <div className="relative" style={{ width: size, height: size }}>
        ...
        >
          ...
          <circle
            ...
            fill="none"
            stroke={
              isComplete ? "rgba(16,185,129,0.08)" : "rgba(212,175,55,0.06)"
            }
            strokeWidth={20}
          />
          ...
          {/* Subtle tick marks at prayer positions */}
          ...
          <circle
            ...
            style={{
              ...
              filter: isComplete
                ? "drop-shadow(0 0 10px rgba(16,185,129,0.7)) drop-shadow(0 0 22px rgba(16,185,129,0.3))"
                : "drop-shadow(0 0 8px rgba(212,175,55,0.7)) drop-shadow(0 0 18px rgba(212,175,55,0.3))",
            }}
          />
              ...
              return (
                <circle
                  ...
                  style={{
                    filter: isFilled
                      ? isComplete
                        ? "drop-shadow(0 0 5px rgba(16,185,129,0.9))"
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <div className="text-center">
            ...
            <span
              ...
              style={{
                color: isComplete ? "#10b981" : "rgba(212,175,55,0.8)",
      ...
      <div className="mt-1 text-center">
        ...
        {isComplete && (
          <p
            className="text-xs font-bold emerald-text mt-1.5 fade-in"
